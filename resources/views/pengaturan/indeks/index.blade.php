                            ...
                            <table class="table table-striped" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <button id="edit_indeks" data-id={{ $data_indeks->id }} data-nama="{{ $data_indeks->nama_indeks }}" class="btn btn-primary float-left" data-toggle="modal" data-target="#exampleModal">
                                           <i class="fas fa-edit"></i> Edit
                                        </button>

                                        <form class="delete" action="{{ route('indeks.destroy',['indek'=>$data_indeks->id]) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <a type="submit" value="Delete" class="btn btn-danger float-left text-white ml-2"><i class="fas fa-trash"></i> Hapus </a>
                                        </form>
                                        </td>
                                    </tr>
                                    @endforeach
